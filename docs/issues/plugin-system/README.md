...
## Issues
- [PLG-001-plugin-role-interfaces-[closed].md](./PLG-001-plugin-role-interfaces-[closed].md)
- [PLG-002-plugin-registry-boot-freeze-[closed].md](./PLG-002-plugin-registry-boot-freeze-[closed].md)
- [PLG-003-authenticity-checker-in-constraint-pipeline-[closed].md](./PLG-003-authenticity-checker-in-constraint-pipeline-[closed].md)
- [PLG-004-brazil-document-plugin-[closed].md](./PLG-004-brazil-document-plugin-[closed].md)
- [PLG-005-latam-document-plugin-migration-[closed].md](./PLG-005-latam-document-plugin-migration-[closed].md)
- [PLG-006-document-validator-conformance-test-[on-work].md](./PLG-006-document-validator-conformance-test-[on-work].md)
